---
title: Ricky's WIKI — 知识索引
tags: [wiki, 知识索引, 个人知识库, 全景]
date: 2026-04-13
type: 知识索引
---
...
Personal knowledge wiki powered by Quartz + Claude Code.

<div class="zh-trans">基于 Quartz + Claude Code 构建的个人知识 Wiki。</div>
...
<div style="margin: 1.25rem 0 1.5rem; padding: 1rem 1.1rem; border: 2px solid var(--secondary); border-radius: 14px; background: linear-gradient(135deg, rgba(120, 119, 198, 0.14), rgba(99, 179, 237, 0.10)); box-shadow: 0 10px 30px rgba(0, 0, 0, 0.08);">
  ...
  <a href="./SkillsMemoryDashboard.html" data-router-ignore style="display: inline-flex; align-items: center; gap: 0.45rem; padding: 0.6rem 0.9rem; border-radius: 999px; background: var(--secondary); color: var(--light); font-weight: 700; text-decoration: none;">打开 Skills Memory Dashboard →</a>
</div>

## Topics

### Palantir
Data analytics and enterprise AI platform company. Key themes: FDE forward deployment model, RaaS (Results as a Service), value-sharing pricing, five-product matrix (AIP/Foundry/Gotham/Ontology/Apollo), NDR 134%.
...
### OTGO
AI company building octo — an open-source enterprise Agent collaboration platform.
Key themes: lobster agents (龙虾), closed-loop (闭环), token economy, multi-agent orchestration, 品 philosophy.

<div class="zh-trans">专注于构建 octo 开源企业 Agent 协作平台的 AI 公司。核心主题：龙虾 Agent、闭环原则、token 经济、多 Agent 协同、品哲学。</div>
...
Technology and market trend analysis. Current focus: quantum computing's impact on GPU acceleration industry and NVIDIA's defense strategy.

<div class="zh-trans">技术和市场趋势分析。当前聚焦：量子计算对GPU加速行业的影响和英伟达的防御策略。</div>

→ [[industry-research/overview|行业研究全景概览]]

---

### 工具方法论 (Tools & Methodology)
Knowledge management and AI-native workflow tools. Current focus: LLM Wiki pattern as personal-scale compounding knowledge base.
...
→ <a href="./SkillsMemoryDashboard.html" data-router-ignore>打开 Skills Memory Dashboard</a>

---

### AI趋势 2026 (AI Trends 2026)
Annual AI trend analysis by statworx & AI Hub Frankfurt. 20 trends across 5 categories: Company (AI ROI accountability), Work (one-person unicorn, B2AI2C), Economy (geopolitics of compute), Society (world models), Technology (DataOps+AgentOps, ChatGPT-as-platform).

<div class="zh-trans">statworx × AI Hub Frankfurt年度AI趋势分析。5大类别20个趋势：企业（AI问责）、工作（独角兽微团队、B2AI2C）、经济（算力地缘政治）、社会（世界模型）、技术（DataOps+AgentOps、ChatGPT平台化）。</div>

→ [[ai-trends/overview|AI趋势全景概览]]
...
中国最大第三方广告监测与DMP平台。核心主题：IVT监测技术革新、明日DMP RaaS化转型（API/MCP开放平台 + ClawHub AI Agents）、DeepMiner AI Use Cases、GEO（生成式引擎优化）、企业AI四阶段框架、超级智能体OS架构。数据源：京东电商行为/银联/百望车辆/航旅/消费品类。
...
### 拾象AI洞察 (Shixiang AGI Insights)
拾象科技年度 LP Meeting 报告（Dec 2025）。核心主题：7个AI关键判断、Continual Learning 是下一代范式、Proactive Agent 是2026年胜负手、AI War（Google vs OpenAI/NVIDIA 两阵营交替领先）、AI Bubble 分析（$1.4T OpenAI 承诺）、Ideal AGI Basket（OpenAI 25% + ByteDance 25% + 其余各10%）、头部AI公司ARR数据。

→ [[shixiang/overview|拾象AI洞察 全景概览]]
...
### 明日数据（Tomorrow Data）
独立第三方 DMP 供应商，2026年向开放平台（API/MCP）+ AI Agent 化转型。已在 ClawHub 发布 DMP Agents（200+ 下载），数据源涵盖京东电商行为、银联、百望车辆、航旅、消费品类。

→ [[mingri/overview|明日数据全景概览]]

---

### 出海营销AIGC (Cross-border Marketing AIGC)
Meta 广告平台自动化背景下的出海 AIGC 创意工具研究。核心主题：Meta Advantage+ 与 Marketing API 边界、数字人营销、行业模板、CAPI 归因管道、创意数据飞轮、自建 vs 集成策略、Meta vs Google 价值链差异。

→ [[cross-border-marketing-aigc/overview|出海营销 AIGC 全景概览]]

---

### AIGC国内玩家方案
国内 AIGC 内容服务玩家面向品牌营销的解决方案研究。当前核心资料：特赞 GMI F26 AIGC 营销素材服务方案、零壹贰叁科技如意 RUYI 多模态 AIGC 生成平台、筷子科技品牌商业 Token 化闭门会。重点包括内容工厂、人机协作交付、品牌专属模型训练、多模态平台、AI 视频分镜工作台、品牌商业 Token 化和智能体运行环境。
...
- 2026-05-12 · [[miaozhen/overview|秒针/明略科技]] — 明日DMP产品分享（2026-05-12）：开放平台 API/MCP（~30个接口）、AI 能力中心（ClawHub DMP Agents 200+ 下载、4节点智能圈包 Agent）；新数据源案例（京东/银联/百望/航旅/消费品类）
- 2026-05-09 · [[ai-trends/overview|AI Trends]] — 拾象 AGI 洞察（2026-05）摄入并合并至 ai-trends：Coding Agent 千亿 ARR、AI Labs 组织战略竞争（Anthropic/OpenAI/Google）、To Human/To Agent 新坐标系、Managed Agents（API→Agent云）、Robotics 数据金字塔（VLA→WAM）、Neo Labs 两条路线
- 2026-05-01 · [[ai-business/overview|AI 商业进化]] — 半瓶水笔记（2026-04-20）：IM+Agent+Skills+KB新一代企业软件架构；50年企业软件三次失败→第四条路（以知识为中心）；IM入口四层逻辑；Skills意图驱动编排；知识飞轮护城河；竞品全景（飞书/Salesforce/Microsoft/Coze/Glean）
- 2026-04-27 · [[otgo/overview|OTGO]] — 事项（Item）设计 V2：事项=结构化工作单元（5字段骨架/append-only品鉴流/Agent可观测通道）、Runtime Agent（CC/Codex/Cursor，组织资产vs OC个人资产）、6个结构性红利（Taste天然内置/数字劳动力分身/不监控悖论解法/OC编排+Runtime执行分工/SaaS账本拆分/真实工作评级）
- 2026-04-27 · [[otgo/overview|OTGO]] — Dual-Native Design v1.5（GUI设计蓝图 v11.2对齐）：Dual-Native原则（底层为Agent而建，表层为人而渲染）、CLI解耦（View/CRUD分离）、File Space（Taste/Context载体）、多CC协作四种模式（串行链/扇出/流式/扇入）、悟空协议（H↔H/H↔A/A↔A）、四端策略（Browser Extension第四端）
- 2026-04-27 · [[otgo/overview|OTGO]] — 战略背景与产品哲学基底（混沌演讲 20260328 + 伦理学 v2.5）：三种存在态（我品故我在）、e复利公式、龙虾三律、龙虾矩阵、数字分身定性、参数化伦理五层架构、Skill Marketplace & Taste回流、知识主权三层保护体系
- 2026-04-21 · [[miaozhen/overview|秒针/明略科技]] — Mano-P 1.0 GUI感知智能体：OSWorld全球第一(58.2%)，13项SOTA，纯视觉操控任意GUI，三种部署形态（本地/算力棒/云API），7大行业场景，Apache 2.0开源
...
- 2026-04-14 · [[ai-business/overview|AI 商业进化]] — New topic: 3 sources (GEA演讲×2, 安克创新), 4 concepts, 2 entities, 1 synthesis
- 2026-04-14 · [[industry-research/overview|行业研究]] — New topic: 量子计算对GPU重构 (1 source, 1 concept)
- 2026-04-14 · [[tools/overview|工具方法论]] — New topic: LLM Wiki模式 (1 source, 1 concept)
