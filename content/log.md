...
- agentic-player/sources/agentic-player-decision-new-paradigm-deepzero-20260622 — 来源页，企业级 Agent 架构、Human-at-the-helm、Agentic Marketing OS、AI 搜索新范式
- agentic-player/concepts/enterprise-agent-architecture — 新概念页：Enterprise Agent Architecture
- agentic-player/concepts/human-at-the-helm — 新概念页：Human-at-the-helm
- agentic-player/concepts/agentic-marketing-os — 新概念页：Agentic Marketing OS
- agentic-player/entities/deepzero — 新实体页：DeepZero / 深演智能
...
- my/sources/haidilao-ai-solution-complete-2026 — 来源页，8页完整汇报：一期1,360家门店数据、三层业务场景、五大场景示例、行业适配矩阵（5个行业）、SaaS订阅+项目制交付双模式收费
- my/overview — 更新：新增来源、时间线补充
...
- 新概念页：proactive-ai, ai-maturity-l1-l4, strategy-matrix-3x3, enterprise-judgment-system
- 新实体页：mars, senma, bosch-pt, midea
- 更新：ai-business/overview

## [2026-04-15] ingest | palantir（新话题）| 2 个资料

- palantir/sources/palantir-biz-model-research-20260113 — Palantir产品和服务商业模式研究（五大产品全景、FDE结构、客单价数据）
- palantir/sources/palantir-private-deploy-revenue-20260115 — Palantir私有化部署持续收费策略（五大持续收费策略、Rio Tinto/DGSI/TITAN案例、Oracle/SAP对标）
- 新概念页：fde-model, raas, value-sharing, ontology, product-portfolio
- 新实体页：palantir
- 新综合页：palantir-business-model-2026q1

## [2026-04-14] ingest | OTGO 补充 | 5 个新资料

- otgo/sources/tianhe-guangneng-raw-20260413 — 天合光能交流纪要（AI转写纠错版）
- otgo/sources/openclaw-vs-hermes-20260412 — OpenClaw vs Hermes 技术对比
- otgo/sources/minglie-charter-v12-20260414 — 明略组织行为准则 v12
- otgo/sources/dmwork-org-guide-20260414 — DMWork 组织行为学指标实战指南
- otgo/sources/met-pricing-analysis-20260414 — MET 报价模式分析
- 新概念页：taste-philosophy, openclaw-search-arch, hermes
- 新实体页：dmwork, met

## [2026-04-14] ingest | ai-business（新话题）| 3 个资料

- ai-business/sources/gea-speech-20260410 — GEA演讲：智能体驱动商业进化
- ai-business/sources/gea-speech-notes-20260410 — GEA演讲精简纪要
- ai-business/sources/anker-ai-20260410 — 安克创新 AI 转型四阶段
- 新概念页：ai-three-stages, gea-architecture, context-system, subjective-world-model
- 新实体页：anker, gea
- 新综合页：ai-business-2026q1

## [2026-04-14] ingest | industry-research（新话题）| 1 个资料

- industry-research/sources/quantum-gpu-20260414 — 量子计算对GPU加速行业的重构
- 新概念页：quantum-nvidia

## [2026-04-14] ingest | tools（新话题）| 1 个资料

- tools/sources/llm-wiki-pattern-20260414 — LLM Wiki 模式（Karpathy）
- 新概念页：llm-wiki

## [2026-04-13] init | Wiki 初始化完成
